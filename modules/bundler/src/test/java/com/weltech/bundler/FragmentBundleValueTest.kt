...
class FragmentBundleValueTest {
  ...
  fun bundleValueDefaultValueTest() {
    ...
    val charSequence: String = fragment.bundleValue("charSequence", "weltech")
    assertThat(charSequence, `is`("weltech"))
  }
  ...
  fun bundleReferenceValueDefaultValueTest() {
    ...
    val bundle: Bundle? =
      fragment.bundleValue("bundle") { Bundle().apply { putString("bundleString", "weltech") } }
    assertThat(bundle?.getString("bundleString"), `is`("weltech"))

    val charSequence: CharSequence? = fragment.bundleValue("charSequence") { "weltech" }
    assertThat(charSequence, `is`("weltech"))
