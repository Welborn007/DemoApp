...
class ActivityBundleValueTest {
  ...
  fun bundleValueDefaultValueTest() {
    ...
    val charSequence: String = activity.bundleValue("charSequence", "weltech")
    assertThat(charSequence, `is`("weltech"))
  }
  ...
  fun bundleReferenceValueDefaultValueTest() {
    ...
    val bundle: Bundle? =
      activity.bundleValue("bundle") { Bundle().apply { putString("bundleString", "weltech") } }
    assertThat(bundle?.getString("bundleString"), `is`("weltech"))

    val charSequence: CharSequence? = activity.bundleValue("charSequence") { "weltech" }
    assertThat(charSequence, `is`("weltech"))
