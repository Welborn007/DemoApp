...
class ActivityBundlerTest {
  ...
  fun activityBundlerTest() {
    ...
    bundler.putExtra("name", "weltech")

    assertThat(activity.intent.getStringExtra("name"), `is`("weltech"))
  }
  ...
  fun activityVariableBundlerTest() {
    ...
    activity.intent = intentOf {
      putExtra("name", "weltech")
    }

    val name by activity.activityVariableBundler("weltech") {
      intent.getStringExtra("name")
    }

    assertThat(name, `is`("weltech"))
  }
  ...
  fun activityVariableBundlerValueTest() {
    ...
    val name = activity.activityVariableBundlerValue("weltech") {
      intent.getStringExtra("name")
    }
