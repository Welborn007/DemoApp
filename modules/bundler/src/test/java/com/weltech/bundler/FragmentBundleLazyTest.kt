...
package com.weltech.bundler

import android.os.Bundle
import com.weltech.bundler.data.Poster
import com.weltech.bundler.data.PosterSerializable
import com.weltech.bundler.data.UserInfo
...
class FragmentBundleLazyTest {
  ...
  fun bundleLazyTest() {
    ...
    assertThat(charSequence, `is`("weltech"))
  }
  ...
  fun bundleLazyDefaultValueTest() {
    ...
    val charSequence: String by fragment.bundle("charSequence", "weltech")
    assertThat(charSequence, `is`("weltech"))
  }
  ...
  fun bundleReferenceLazyTest() {
    ...
    fragment.arguments = intentOf {
      ...
      putExtra("bundle", Bundle().apply { putString("bundleString", "weltech") })
      putExtra("charSequence", "weltech")
    ...
    assertThat(bundle?.getString("bundleString"), `is`("weltech"))
  ...
  fun bundleReferenceLazyDefaultValueTest() {
    ...
    val bundle: Bundle? by fragment.bundle("bundle") { Bundle().apply { putString("bundleString", "weltech") } }
    assertThat(bundle?.getString("bundleString"), `is`("weltech"))

    val charSequence: CharSequence? by fragment.bundle("charSequence") { "weltech" }
    assertThat(charSequence, `is`("weltech"))
  ...
  fun bundleArrayLazyTest() {
    ...
    val poster = Poster.create()
    fragment.arguments = intentOf {
      putExtra("stringArray", arrayOf("weltech0", "weltech1", "weltech2"))
      putExtra("charSequenceArray", arrayOf("weltech0", "weltech1", "weltech2"))
  ...
  fun bundleArrayLazyDefaultValueTest() {
    ...
    val stringArray by fragment.bundleArray("stringArray") {
      arrayOf("weltech0", "weltech1", "weltech2")
    }
    assertThat(stringArray?.size, `is`(3))
    assertThat(stringArray?.get(0), `is`("weltech0"))
  ...
  fun bundleArrayListLazyTest() {
    ...
    val poster = Poster.create()
    fragment.arguments = intentOf {
      putExtra("stringArrayList", arrayListOf("weltech0", "weltech1", "weltech2"))
      putExtra("charSequenceArrayList", arrayListOf("weltech0", "weltech1", "weltech2"))
    ...
    assertThat(stringArrayList?.get(0), `is`("weltech0"))
    ...
    assertThat(charSequenceArrayList?.get(0), `is`("weltech0"))
  ...
  fun bundleArrayLsitLazyDefaultValueTest() {
    ...
    val stringArrayList by fragment.bundleArrayList("stringArrayList") {
      arrayListOf("weltech0", "weltech1", "weltech2")
    }
    assertThat(stringArrayList?.size, `is`(3))
    assertThat(stringArrayList?.get(0), `is`("weltech0"))
