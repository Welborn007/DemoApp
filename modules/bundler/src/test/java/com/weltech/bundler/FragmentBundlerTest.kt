...
class FragmentBundlerTest {
  ...
  fun fragmentBundlerTest() {
    ...
    assertThat(bundler.intent.getStringExtra("name"), `is`("weltech"))
  }
  ...
  fun fragmentVariableBundlerTest() {
    ...
    val name by fragment.fragmentVariableBundler("weltech") {
  ...
  fun fragmentVariableBundlerValueTest() {
    ...
    val name = fragment.fragmentVariableBundlerValue("weltech") {
      intent.getStringExtra("name")
    }
