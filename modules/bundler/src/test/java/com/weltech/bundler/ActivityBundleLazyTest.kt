...
class ActivityBundleLazyTest {
  ...
  fun bundleLazyDefaultValueTest() {
    ...
    val charSequence: String by activity.bundle("charSequence", "weltech")
    assertThat(charSequence, `is`("weltech"))
  }
  ...
  fun bundleReferenceLazyDefaultValueTest() {
    ...
    val bundle: Bundle? by activity.bundle("bundle") { Bundle().apply { putString("bundleString", "weltech") } }
    assertThat(bundle?.getString("bundleString"), `is`("weltech"))

    val charSequence: CharSequence? by activity.bundle("charSequence") { "weltech" }
    assertThat(charSequence, `is`("weltech"))
