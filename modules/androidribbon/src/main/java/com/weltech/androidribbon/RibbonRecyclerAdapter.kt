...
package com.weltech.androidribbon

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.weltech.androidribbon.databinding.ItemRibbonAndroidribbonWeltechBinding
...
class RibbonRecyclerAdapter :
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RibbonRecyclerViewHolder {
    ...
    return RibbonRecyclerViewHolder(
      ItemRibbonAndroidribbonWeltechBinding.inflate(inflater, parent, false)
    )
  }
  ...
  class RibbonRecyclerViewHolder(
    private val binding: ItemRibbonAndroidribbonWeltechBinding
