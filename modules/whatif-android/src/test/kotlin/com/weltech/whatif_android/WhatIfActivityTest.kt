...
import com.weltech.whatif_android.data.Poster
import com.weltech.whatif_android.data.PosterSerializable
...
internal class WhatIfActivityTest {
  ...
  fun whatIfHasDeepLinkUriTest() {
    mainTestActivity.intent.data = Uri.parse("weltech")
    ...
    assertThat(deepLinkUri.toString(), `is`("weltech"))
  }
